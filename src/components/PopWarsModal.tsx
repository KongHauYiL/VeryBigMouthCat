        ...
        <div className="p-6 space-y-6">
          {isLoading ? <div className="text-center">
              ...
              <div className="text-center mb-6">
                <p className="text-white/80 text-sm">The Superior Soda?</p>
              ...
              return <div key={choice.id} className="space-y-2">
                      <Button onClick={() => handleVote(choice.id)} disabled={isVoting} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-medium py-4 text-lg">
                        {choice.choice_text}
                      </Button>

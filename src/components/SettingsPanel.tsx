      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="username" value={settings.username} onChange={e => updateSettings({
            username: e.target.value
          })} placeholder="Enter your username" className="bg-white/20 backdrop-blur-md border-white/30 focus:border-rose-400" />
          ...
          <div className="flex items-center justify-between bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
            ...
            <Switch id="vibration" checked={settings.vibrationEnabled} onCheckedChange={checked => updateSettings({
